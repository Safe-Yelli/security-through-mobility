...
busRoutes <- geojsonio::geojson_sf('kgis-arcgis-api/bus-routes.geojson') %>%
...
#|      - Small and Neighbourhood Road Network
#|      - Bus Route Network 


plot(bloreRoadsSecondary_1, col="red", lwd= 0.5)
plot(bloreRoadsSmall, col="red", lwd= 0.5)
plot(busRoutes_1, col="#1e1e1e", lwd= 0.5)
...
filteredSecondaryRoads <- bloreRoadsSecondary_1 %>%
            activate("edges") %>%
            filter(edge_intersects((busRoutes_1)))


plot(st_geometry(filteredSecondaryRoads, "edges"), lwd=1, col="red", bg= "#1e1e1e" )
plot(st_geometry(busRoutes_1, "edges"), col="#ccccbc", add=TRUE)
plot(st_geometry(filteredSecondaryRoads, "edges"), lwd=1, col="red", bg= "#1e1e1e" )
